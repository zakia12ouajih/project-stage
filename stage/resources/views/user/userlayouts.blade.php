...
<div id="demo1" class="collapse py-1">
   <a class="dropdown-item text-center" href='/user/data_delis'>جنحي</a>
   <a class="dropdown-item text-center" href="/user/data_civil">مدني</a>
</div> 
@endsection
@section('cas_civil')
   <a href="#" class="collapse nav-link text-center dropdown-toggle d-flex justify-content-center  align-items-center text-right " data-bs-toggle="collapse" data-bs-target="#demo3">{{ __('msg.cas_civil') }}</a>
      <div id="demo3" class="collapse py-1">
         <a class="dropdown-item text-center" href='/user/voir_cas_civil'>{{ __('msg.voir_cas_civil') }}</a>
      </div> 
@endsection
@section('cas_delis')
   <a href="#" class="collapse nav-link text-center dropdown-toggle d-flex justify-content-center  align-items-center text-right " data-bs-toggle="collapse" data-bs-target="#demo4">{{ __('msg.cas_delis') }}</a>
      <div id="demo4" class="collapse py-1">
         <a class="dropdown-item text-center" href='/user/voir_cas_delis'>{{ __('msg.voir_cas_delis') }}</a>
      </div> 
@endsection 
@section('statistique')
...
<div id="demo5" class="collapse py-1">
   <a class="dropdown-item text-center" href='/user/staticCasDelis'>{{ __('msg.statistic_cas_delis') }}</a>
   <a class="dropdown-item text-center" href="/user/staticCasCivil">{{ __('msg.statistic_cas_civil') }}</a>
</div> 
@endsection
